...
class BendClipboard2Activity : AppCompatActivity() {
    ...
    if (hasFocus) {
      val text =
        (getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager)
          ...
          ?.getItemAt(0)
          ?.coerceToText(this)
      if (preferences.clipboardDestination2 == TextbenderPreferences.Destination.DISABLED) {
        ...
        Textbender.handleText(this, toaster, preferences, preferences.clipboardDestination2, text)
      }
      finish()
    }
  }
